...
if (-not ($DisableDriverUpdates -or $DisableAutoRestart -or $DeferFeatureUpdates -or $DeferQualityUpdates)) {
    Write-Output "[!] No options selected. Please select at least one setting to apply."
    exit 0
}
...
if ($DisableDriverUpdates) {
    ...
    Write-Output "  [OK] Driver updates disabled"
    Write-Output ""
}
...
if ($DisableAutoRestart) {
    ...
    Write-Output "  [OK] Automatic restart disabled"
    Write-Output ""
}
...
if ($DeferFeatureUpdates) {
    ...
    Write-Output "  [OK] Feature updates deferred: 365 days"
    Write-Output ""
}
...
if ($DeferQualityUpdates) {
    ...
    Write-Output "  [OK] Quality updates deferred: 4 days"
    Write-Output ""
}

# Summary
Write-Output "========================================="
Write-Output "[SUCCESS] Windows Update settings configured!"
Write-Output "========================================="
Write-Output ""
